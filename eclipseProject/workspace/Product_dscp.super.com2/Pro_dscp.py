...
#输入账号、密码、验证码进行登录操作
#输入账号
driver.find_element_by_xpath("//*[@id='app']/div/div[2]/div/div/div[2]/form/div[1]/div/div/input").send_keys("admin")
#输入密码
driver.find_element_by_xpath("//*[@id='app']/div/div[2]/div/div/div[2]/form/div[2]/div/div/input").send_keys("1qaz@wsx")
#输入验证码
...
driver.find_element_by_xpath("/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[1]/div[5]/button").click()
#点击查看按钮
driver.find_element_by_xpath('//*[@id="app"]/div/div[2]/div[2]/div/div/div/div[2]/table/tr[2]/td[10]/span[1]')
time.sleep(3)
