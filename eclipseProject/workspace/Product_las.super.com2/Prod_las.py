...
#打开审批系统
driver.get("http://las.juxinda360.com/view/login.html")
driver.maximize_window()
#点击登录系统的进行登录操作
#账号
element("/html/body/div[2]/div/form/label[1]/div/input").send_keys("admin")
#密码
element("/html/body/div[2]/div/form/label[2]/div/input").send_keys("1qaz@wsx")
#验证码
...
#####以下步骤在生产中无法操作——————>admin无待审权限，页面元素定位不一致
